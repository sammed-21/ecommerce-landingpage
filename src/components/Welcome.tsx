...
<div className="flex flex-wrap gap-4 w-full flex-row ">
  ...
  <WelcomeCard image={alert} title='Customize Customer Notification' description='Tailor Your Email Experience: Set the Sender Email and Choose Notification Triggers' buttontitle='Configure Notification' className='bg-[#FFF8DB] text-[#5E4200] max-md:min-w-full' />
